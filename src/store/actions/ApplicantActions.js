...
export const GET_APPLICANTGRANTS_START = "GET_APPLICANTGRANTS_START";
export const GET_APPLICANTGRANTS_SUCCESS = "GET_APPLICANTGRANTS_SUCCESS";
export const GET_APPLICANTGRANTS_FAILURE = "GET_APPLICANTGRANTS_FAILURE";
